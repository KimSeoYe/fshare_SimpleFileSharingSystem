...
It is a simple file sharing system, such as a dropbox.<br>
You can first specify a directory to share on the server side.<br>
Then, when multiple clients are connected, changes to one client are reflected in the server and all other clients.<br>
Of course, versions of the files are managed and synchronized except for a deletion of files.
